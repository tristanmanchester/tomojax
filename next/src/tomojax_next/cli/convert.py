...
Usage examples:
  ...
  pixi run python -m tomojax_next.cli.convert --in data/sim.npz --out data/sim.nxs
  pixi run python -m tomojax_next.cli.convert --in data/sim.nxs --out data/sim.npz
"""
