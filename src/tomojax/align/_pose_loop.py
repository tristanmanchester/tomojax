...
from ._model.gauge import active_gauge_dofs, normalize_gauge_fix, validate_alignment_gauge_feasible
from ._objectives.fixed_volume import ObjectiveProvenance, alignment_projector_backend_provenance
from ._objectives.loss_adapters import build_loss_adapter
from ._objectives.loss_specs import loss_spec_name, resolve_loss_for_level
...
from ._pose_steps import AlignmentStepContext, _run_alignment_step
