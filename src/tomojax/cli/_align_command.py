...
def build_parser() -> argparse.ArgumentParser:
    ...
    _ = p.add_argument(
        ...
        default=None,
        metavar="PATH",
        help="Resume alignment from a checkpoint. Restores optimise_dofs, freeze_dofs, and schedule from the checkpoint unless those options are set explicitly. Defaults future checkpoint writes to this path.",
    )
