...
- Supported parallel-tomography DOFs are nominal theta, theta offset, phi
  residual, detector u/v shift, and per-view dx/dz.
- Detector roll, axis rotations, laminography, alpha/beta, and object drift are
  explicit unsupported states until their core convention mapping is defined.
...
- `tests/test_forward_reference.py` covers the v2-to-core adapter, supported
  detector/theta shifts, and robust residual contracts.
